 ...
 *
 */
public class MiMicJsWebSocket extends WebSocketClient
{
...
//	ArrayList<String> _s;
	int _status;
	public MiMicJsWebSocket(URI i_uri) throws MiMicJsException
	{
		super(i_uri,new Draft_17());
		this._status=ST_NONE;
	}
	public String recvBlocking() throws MiMicJsException,InterruptedException
	{
		synchronized(this){
