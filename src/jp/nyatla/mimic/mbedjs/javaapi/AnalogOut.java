...
{
	public AnalogOut(Mcu i_mcu,int i_pin) throws MiMicJsException
	{
	...
	public void write(double i_value) throws MiMicJsException{
	...
	public void write_u16(int i_value) throws MiMicJsException{
