...
public class GraphicsDisplay extends TextDisplay {
	...
	//public void blit(int x, int y, int w, int h, const int *colour);    
	//public void blitbit(int x, int y, int w, int h, const char* colour);
	...
	//private static final byte FONT8x8[97][8] = {
